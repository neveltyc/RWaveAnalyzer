...
# trace needs design connectivity, which no waveform-only backend has. The
# refusal must be clean (exit 1, explanatory text), never a partial answer.
terr=$($RW trace "$HF" hier_deep.u_m0.u_a.clk 2>&1); tcode=$?
